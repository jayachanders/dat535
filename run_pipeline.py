...
def main():
    ...
    parser.add_argument('pipeline', choices=['data', 'mapreduce', 'both'],
                       help='Which pipeline to run: data (basic), mapreduce (advanced), or both')
    
    args = parser.parse_args()
    
    if args.pipeline == 'data' or args.pipeline == 'both':
        print("=" * 70)
    ...
    if args.pipeline == 'mapreduce' or args.pipeline == 'both':
        print("\n" + "=" * 70)
